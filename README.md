...
| **Criterio específico** | **Acciones realizadas** | **ones** |
| --- | --- | --- |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | Christopher Sebastian More Rondon:<br><br>TB1: Para esta entrega me encargue de hallar a nuestros posibles competidores, así como analizar sus puntos fuertes y débiles. También comuniqué durante la exposición cuales son nuestros segmentos objetivos y los requisitos que nuestra aplicación debe cumplir para satisfacer sus necesidades<br><br>TP: En esta entrega me encargue del Bounded Context Transacciones, realice esta parte utilizando un fake api para sacar los datos<br><br>TB2:Para esta entrega me encargue del Bounded Context de Transacciones, donde analizó el caso y realize el Backend para que el usuario pueda visualizar sus compras realizada<br><br>TF: Para esta entrega realize el bounded contex de transacciones en el back end y lo conecte con el front end para obtener informacion sobre las transacciones realizadas<br><br>Joaquin Antonio Cortez Quezada<br><br>TB1: Para esta entrega se investigó sobre los principios de diseño para la página web para el diseño de los mock ups, considerando las users stories y las funcionalidades core del startup<br><br> TP: Investigue sobre la metodologia DDD para ponerla en practica al momento de trabajar en angular y poder desarrollar un buen bounded context <br><br> TF: Para esta entrega realize el bounded contex de envios en el back end y lo conecte con el front end para obtener informacion sobre las transacciones realizadas<br> <br>Tony Alexander Ramos Najar<br><br>TB1: Para esta  entrega me encargué de la formulación del Ubiquitous Language, es fundamental para que nuestro consumidores y nuestra aplicación puedan entenderse, además de implementar el impact Mapping, considerando el user story respectivo posteriormente a mi entrevista realizada <br><br>TP: Para la entrega del Trabajo parcial, implementé las historias usuario en Trello y complementé al despliegue del front-end. Además formulé el json del BC Category, a parte de implementar los estilos y más. <br><br>TB2: Con respecto a esta entrega, implementé la lógica del Back-end Categorías, además de sus Endpoints tales como los POST, GET, SET, DELETE a través de Swagger Api v3. También colaboré en la corrección del feedback del trabajo parcial, corrigiendo algunos detalles del Trello, Front-end, documentación, etc. En el Front, Actualicé algunos metodos para optimizar el código y mejorar el rendimiento de la aplicación, especialmente en operaciones costosas en términos de recursos. <br><br>TF: Durante el sprint actual, implementé exitosamente el Bounded Context de Categorías, configuré CORS para la comunicación fluida entre el frontend en Angular y el backend en Swagger JavaScript, y desarrollé cinco endpoints funcionales al 100% en PostgreSQL, mientras desplegué el frontend en Firebase y el backend en localhost.   <br><br>Adriano Sebastian Cruz Palomino<br><br>TB1: En esta entrega, identifiqué las necesidades de los usuarios y compartí estos hallazgos con mis compañeros. Así, pudimos discutir y colaborar eficazmente dentro del equipo del proyecto.<br><br>TP: En esta entrega, realice el desarrollo del frontend del bounded context Publications. Tambien, correcciones en la landing<br><br>TB2: Para esta entrega, realice todos los endpoints necesarios para desplegar la parte del frontend que realice en la entrega pasada<br><br>TF: En esta entrega, finalicé el desarrollo del frontend y backend del Bounded Context Publications, asegurando una integración fluida y funcional. Implementé correcciones basadas en el feedback recibido, mejorando la experiencia de usuario en la landing page y en el manejo de publicaciones.<br><br>Alexander Jair Castillo Castillo<br><br>TB1:  <br>para esta entrega identifiqué el problema que solucionaremos, el principal segmento objetivo en el que nos enfocaremos. Así mismo, planteé algunas hipótesis, riesgos y soluciones respecto al desarrollo de esta. Tomé desiciones de diseño para la landing page. <br><br>TP:  <br>Para esta entrega me encargue del frontend de el bounded context de "Alquiler Bc". Asimismo me encargue de varias correciones en el informe.<br><br>TB2: <br>Para esta entrega identifiqué las correcciones que debiamos presentar, hice un mapeo general organizandolas por task donde cada uno fue completando a lo largo del Plazo.  Me encargue del Backend de mi bounded cotnext "Alquiler" y de algunos puntos del 5.3-5.4 en el documento. <br><br>TF: Durante esta entrega, completé la implementación del Bounded Context de Alquiler tanto en el frontend como en el backend. Me aseguré de que todas las correcciones identificadas previamente fueran aplicadas. Además, realicé pruebas funcionales y de integración para garantizar la calidad del sistema.|Para esta entrega, el equipo realizó una serie de actividades fundamentales para el desarrollo del proyecto. Se investigaron competidores y se analizaron sus puntos fuertes y débiles, se diseñaron mock ups teniendo en cuenta las user stories y funcionalidades esenciales, se formuló un Ubiquitous Language y se aplicó Impact Mapping para facilitar la comunicación y comprensión del proyecto. Además, se identificaron las necesidades de los usuarios y se compartieron estos hallazgos para promover la colaboración efectiva. Se tomaron decisiones respecto a la resolución de problemas, riesgos y soluciones, así como decisiones de diseño para la landing page.|
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | Christopher Sebastian More Rondon:<br><br>TB1: En el documento rellené el cuadro de competidores, mostrando sus puntos débiles y fuertes al igual que los nuestros. También me encargué de describir las herramientas utilizadas.<br><br>TP: Mi aporte para esta entrega fue hacer el despliegue en el frontend del bounded context Transaccion<br><br>TB2:Para esta entrega realize el Backend de Transacciones, donde le muestro al usuario su historial de transacciones rralizadas con anterioridad.<br><br>TF:En esta entrega realize el backend  de transacciones y lo conecte con el front end, para que el usuario pueda observar las transacciones llevadas a cabo con anterioridad.<br><br>Joaquin Antonio Cortez Quezada<br><br>TB1: Considerando las funcionalidades principales de nuestro proyecto, diseñe los wireframes, mockups y landing page. En cada uno se considero los principios de diseño. Asimismo, siguiendo el modelo ágil, redacte el ux canva y las user stories. <br><br>TP: Me encargue del desarrollo del bounded context relacionado al lista de envíos de los usuarios, asimismo, tambien trabajo los bounded context de usuarios y chats de los mismos<br><br>TB2:Para esta entrega aporte con el desarrollo de las historias de usuario relacionadas al developer de nuestra aplicación, asimismo me encargue de desarrollar del backend relacionada al bounded context Envíos. <br> <br>TF:En esta entrega realize el backend  de envios y lo conecte con el front end, para que el usuario pueda observar las transacciones llevadas a cabo con anterioridad.<br> <br>Tony Alexander Ramos Najar<br><br>TB1: En el presente documento, implementé la sección colaboración en la Landing Page, principalmente para aquellos que deseen trabajar con nosotros y formar una alianza en el mercado, además de realizar la modificación del documento al formato MarkDown.<br><br> TP:  En el Trabajo Parcial, gestioné historias de usuario en Trello y desplegué el frontend. Formulé el JSON del BC Category y trabajé en estilos.<br><br> TB2: Mi capacidad para comunicar ideas y resultados de manera efectiva se ha demostrado en el desarrollo del proyecto de categorías. Durante este proceso, implementé la lógica del backend y actualicé el frontend, al tiempo que colaboré en la corrección del feedback del trabajo parcial. A través de la documentación detallada de los endpoints en Swagger API v3, aseguré que otros desarrolladores pudieran comprender fácilmente la funcionalidad de la API. Además, la implementación de la validación de datos en el backend garantiza la corrección y consistencia de los datos, y la optimización del rendimiento mejora la eficiencia de la aplicación. Estas habilidades de comunicación han sido clave para transmitir ideas técnicas de manera clara y objetiva, tanto a compañeros de equipo como a superiores jerárquicos, contribuyendo así al éxito del proyecto en ingeniería.  <br><br>TF: Durante este sprint, implementé el Bounded Context de Categorías y configuré CORS para facilitar la comunicación entre el frontend y el backend. Desarrollé cinco endpoints funcionales en PostgreSQL y desplegué el frontend en Firebase, manteniendo el backend localmente. Además, colaboré en la edición del documento para el sprint 4, produje un video sobre el producto y mejoré la eficiencia de Trello para la gestión del proyecto. <br><br>Adriano Sebastian Cruz Palomino<br><br>TB1: En este informe, he realizado un análisis profundo de las necesidades de nuestros usuarios. Además, he desarrollado empathy map y el user journey map, herramientas que me han permitido comprender de manera más efectiva las experiencias y expectativas de nuestros usuarios.<br><br>TP: En esta entrega realice el bounded context de Publications y realice metodos post para la publicacion de una nueva prenda<br><br>TB2: En esta entrega realice en el backend todos los metodos http necesarios para que mi frontend funcione<br><br>TF: En esta entrega, completé el desarrollo del backend para el Bounded Context de Publications, implementando todos los métodos HTTP necesarios para el correcto funcionamiento del frontend. Realicé pruebas exhaustivas para asegurar la integridad y eficiencia del sistema, y ajusté el diseño de la landing page según el feedback recibido.<br><br>Alexander Jair Castillo Castillo<br><br><br>TB1:Al identificar distintos aspectos base de nuestra start up tomé en cuenta las necesidades y limitaciones de nuestros usuarios, tanto para el lean ux canva como para la interfaz de la landing page.<br><br>TP: En esta entrega hice algunas correcciones de l a landing page y el desarrollo del bounded context rent en el frontend<br><br>TB2: Para esta entrega realice los endpoints necesarios para desplegar correctamente mi frontend utilizando metodos crud <br><br>TF: Durante esta entrega, implementé los endpoints necesarios para el correcto despliegue del frontend del Bounded Context de Alquiler, utilizando métodos CRUD. Realicé pruebas de integración para asegurar que todos los componentes del sistema funcionen de manera cohesiva, y realicé ajustes finales en la landing page para mejorar la experiencia del usuario.|  En esta entrega, cada miembro del equipo desempeñó roles específicos y contribuyó con aspectos clave para el desarrollo del proyecto. Se realizó una investigación exhaustiva de los competidores, destacando sus puntos fuertes y débiles, así como la descripción de las herramientas utilizadas. Se diseñaron wireframes, mockups y una landing page teniendo en cuenta las funcionalidades principales del proyecto y los principios de diseño, además de redactar el UX Canva y las user stories siguiendo el modelo ágil. Se implementó una sección de colaboración en la Landing Page para establecer alianzas en el mercado y se modificó el documento al formato Markdown para una mejor organización.   |
...
<br>
![image](Imagenes/WireFrames/WF1/Ordenes.jpg)
<br>
...
| ---- |---------------------------| --- |---------------------------------|---------------------------------------------------------------------------------------------------------------------|--------------------| ------------- |----------------------------------------|
| EP02 | Como usuario quiero poder buscar la prenda que me interesa.            | US05 | Búsqueda de prendas en la aplicación web  | Como usuario quiero buscar prendas por la app para seleccionar aquellas que se acomoden a mis preferencias.                                    | 3                  |   | -                                      |
| EP01 | Como usuario quiero tener un registro y configuración del perfil del usuario  | US03 | Inicio de sesión | Como usuario, quiero recibir un correo electrónico de verificación después de registrarme. | 2                  | Joaquin Antonio | -                                      |
|EP01 | Como usuario quiero tener un registro y configuración del perfil del usuario  | US03 | Registro de usuario    |  Como usuario, quiero registrarme en la aplicación web para acceder a todas sus funcionalidades.    | 2                  |  Tony Alexander  | -                                      |
| EP05 | Como usuario quiero tener la opción de publicar mis prendas         | US12 | Crear una nueva publicacion        | Como usuario quiero tener la posibilidad de publicar las prendas en buen estado que ya no uso en la aplicación para generar algún tipo de ingreso.      | 5                 |  Jair Castillo  | -                                      |
| EP04 | Como usuario quiero poder realizar el alquiler de una prenda    | US11 | Realizar alquiler de prendas   | Como usuario, quiero poder realizar el alquiler de una prenda por un tiempo determinado para tenerla en mi poder.   | 3                  |  Christopher Sebastian  | -                                      |
| EP04 | Como usuario quiero poder realizar el alquiler de una prenda  | US10 | Ver sección de alquiler en la aplicación       | Como usuario, quiero poder acceder al alquiler de cualquier prenda en la aplicación para adquirir la prenda.             | 4                  | Jair Castillo | Done                                   |
| EP04 |Como usuario quiero poder realizar el alquiler de una prenda | US24  | Ver carrito de compras   | Como usuario, quiero dirigirme al carrito y revisar los productos agregados para realizar el pago de varios productos en una sola transacción.             | 3                  | Adriano Cruz | -              |
| EP03 | Como usuario quiero obtener información detallada la prenda de mi interés | US25 | Visualizar lista de envíos   | Como usuario, quiero poder visualizar los envíos de mis prendas para hacer un seguimiento del estado en el cual se encuentra el envío, además de visualizar los datos más importantes de cada prenda.             | 3                  | Adriano Cruz | -              |
| EP02 | Como usuario quiero poder buscar la prenda que me interesa. | US26 | Ver todas las categorías   | Como usuario, quiero poder ver todas las categorías de prendas disponibles en la aplicación.          | 3                  | Adriano Cruz | -              |
...
Alquiler:
![image](https://github.com/SI729-2401-WS51-Grupo-4/documentation/assets/142842509/ba326175-cded-4e7d-8281-8d3d413fcb98)
![image](https://github.com/SI729-2401-WS51-Grupo-4/documentation/assets/142842509/08d0c365-9dd9-42f7-89e4-56867b14bb1e)
![image](https://github.com/SI729-2401-WS51-Grupo-4/documentation/assets/142842509/821cf716-28b0-4689-909d-38c1042f91f7)
...
4. **Estructura de la Entrevista**:
    ...
    - **ón**: Preguntar sobre las impresiones generales y sugerencias.
